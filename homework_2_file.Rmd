...
```{r}
# read
report <- read_csv("homework_2/Report_Card_Assessment_Data_2018-19_School_Year.csv")
...
# na.rm = removes any NAs
# summarise at allows us to select columns to summarise - in this case sum the column
